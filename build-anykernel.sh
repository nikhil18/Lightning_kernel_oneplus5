...
REPACK_DIR="${HOME}/home/nikhil/android/anykernel"
PATCH_DIR="${HOME}/home/nikhil/android/anykernel/patch"
MODULES_DIR="${HOME}/home/nikhil/android/anykernel/ramdisk/lightning/modules"
